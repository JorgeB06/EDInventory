...
{
    /// <summary>
    /// Mantenimiento programado o completado para un activo clínico de ingeniería (<see cref="EngAsset"/>).
    /// El estado puede ser <c>PENDIENTE</c>, <c>COMPLETADO</c> o <c>CANCELADO</c>.
    /// Los registros PENDIENTE con fecha vencida generan alertas en el Dashboard de la división Servicio.
    /// Tabla: TB_ENG_MAINT
    /// </summary>
    [Table("TB_ENG_MAINT")]
    public class EngMaintenance
    {
        ...
        /// <summary>FK al activo clínico al que corresponde este mantenimiento.</summary>
        [Column("ASSET_CODE")]
        ...
        /// <summary>Activo clínico al que corresponde este mantenimiento.</summary>
